...
export default function Profile() {
  ...
  const updateProfileMutation = useMutation({
    ...
    onError: (error) => {
      ...
      toast.error(
        'Ocorreu um erro ao atualizar o perfil. Tente novamente em instantes.'
      );
    },
  });
  ...
  const uploadAvatarMutation = useMutation({
    ...
    onError: (error) => {
      if (isAxiosError(error)) {
        ...
        toast.error(
          'Ocorreu um erro ao atualizar avatar. Tente novamente em instantes.'
        );
      }
    },
  });
  ...
  return (
    <div className='flex h-full w-full flex-col overflow-y-auto rounded-lg bg-white px-10 py-5 shadow-lg'>
        ...
        <div className='relative mb-4 h-32 w-32'>
          {uploadAvatarMutation.isPending ? (
            ...
            <Image
              ...
              alt='Foto de perfil'
              fill
              className='rounded-full border-1 border-solid border-gray-300 object-contain'
            />
          ) : (
            <div className='bg-primary-100 flex h-full w-full items-center justify-center rounded-full'>
          ...
          <label
            className='bg-primary-500 hover:bg-primary-600 absolute right-0 bottom-0 cursor-pointer rounded-full p-2 text-white transition'
      ...
      <form
        ...
        className='mx-auto space-y-6 md:w-1/3'
      >
